                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: Icon(
                          category?['icon'] ?? Icons.add_photo_alternate,
                    ...
                    Expanded(
                        child: TextField(
                            decoration: const InputDecoration(
                                labelText: 'Base Rate (Rs)',
                                border: OutlineInputBorder()),
                            keyboardType: TextInputType.number,
                            controller: TextEditingController(
                                text:
                                    category?['baseRate']?.toString() ?? ''))),
                    const SizedBox(width: 16),
                    const Expanded(
                        child: TextField(
                            decoration: InputDecoration(
                                labelText: 'Complexity Mult.',
                                border: OutlineInputBorder()),
                            keyboardType: TextInputType.number)),
                  ],
                ),
          ...
          return Card(
            ...
            child: ListTile(
              ...
              subtitle: Padding(
                ...
                child: Text(
                    'Providers: ${cat['providers']} • Bookings: ${cat['bookings']}\nBase Rate: Rs ${cat['baseRate']}',
