...
class AntigravityLogsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AntigravityLogsScreen> createState() =>
      _AntigravityLogsScreenState();
}
...
class _AntigravityLogsScreenState extends ConsumerState<AntigravityLogsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Antigravity AI Logs',
    ...
    return Card(
      ...
      child: ExpansionTile(
        ...
        subtitle: const Padding(
          ...
          child: Text('Conf: 92% • Latency: 1240ms • Cost: \$0.0002',
