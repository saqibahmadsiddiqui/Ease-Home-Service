          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('Remove from Blacklist',
                    style:
                        TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                const SizedBox(height: 8),
                const Text('Enter your Admin PIN to confirm this action.',
  ...
  Widget _buildBlacklistCard() {
    return Card(
      ...
      child: Container(
        decoration: BoxDecoration(
          border:
              const Border(left: BorderSide(color: AppColors.error, width: 6)),
          borderRadius: BorderRadius.circular(12),
        ),
        padding: const EdgeInsets.all(16),
        child: Column(
          ...
          children: [
            ...
            const Text('Trigger Reason:',
                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
            const SizedBox(height: 4),
            const Text(
                'Multiple extreme quality complaints and AI-detected aggressive chat behavior.',
                style: TextStyle(color: AppColors.error, fontSize: 12)),
            const SizedBox(height: 8),
            const Text('Banned on: May 01, 2026 by Admin System',
