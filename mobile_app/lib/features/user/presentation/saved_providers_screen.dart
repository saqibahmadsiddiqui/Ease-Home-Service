...
class SavedProvidersScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SavedProvidersScreen> createState() => _SavedProvidersScreenState();
}
...
class _SavedProvidersScreenState extends ConsumerState<SavedProvidersScreen> {
      ...
      builder: (ctx) {
        return Padding(
          ...
          child: Column(
            ...
            children: [
              const Icon(Icons.favorite_border, size: 48, color: AppColors.error),
              const SizedBox(height: 16),
              const Text('Remove from Saved?', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              const SizedBox(height: 8),
              const Text('Are you sure you want to remove this provider from your saved list?', textAlign: TextAlign.center),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Saved Providers', style: TextStyle(color: AppColors.textPrimary)),
        backgroundColor: AppColors.background,
        elevation: 0,
        automaticallyImplyLeading: false, // assuming it might be accessed differently or is a root tab
      ),
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text('${provider['rating']} • ${provider['distance']}'),
                              ],
                            ),
                          ],
                        ),
                  ...
                  Row(
                    children: (provider['skills'] as List<String>).map((skill) => Container(
