...
class DisputeFilingScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<DisputeFilingScreen> createState() =>
      _DisputeFilingScreenState();
}
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  onTap: () => setState(
                      () => _selectedDisputeType = type['id'] as String),
                  child: Container(
            ...
            const SizedBox(height: 24),
            const Text('Evidence Photos (Up to 3)',
                style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
            ...
            Row(
              children: List.generate(3, (index) {
                return Container(
                  ...
                  child:
                      const Icon(Icons.add_a_photo, color: AppColors.inactive),
                );
              }),
            ),
            const SizedBox(height: 24),
            Row(
              ...
              children: [
                const Text('Urgent Assistance Required?',
