...
class _AvailabilityCalendarScreenState extends ConsumerState<AvailabilityCalendarScreen> {
      ...
      builder: (ctx) {
        return Padding(
          ...
          child: Column(
            ...
            children: [
              const Text('May 18, 2026', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Availability', style: TextStyle(color: AppColors.textPrimary)),
        backgroundColor: AppColors.background,
        elevation: 0,
        ...
        child: Column(
          ...
          children: [
              ...
              child: Row(
                ...
                children: [
                  const Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Accepting Requests', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                      SizedBox(height: 4),
                      Text('Toggle to instantly go offline', style: TextStyle(color: AppColors.textSecondary, fontSize: 12)),
                    ],
                  ),
                  Switch(
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                const Text('May 2026', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                Row(
                  children: [
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: const Center(child: Text('Calendar Grid UI Placeholder\n(Tap to simulate day select)', textAlign: TextAlign.center, style: TextStyle(color: AppColors.textSecondary))),
              ),
            ),
            const SizedBox(height: 32),
