...
class DisputeResponseScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<DisputeResponseScreen> createState() =>
      _DisputeResponseScreenState();
}
...
class _DisputeResponseScreenState extends ConsumerState<DisputeResponseScreen> {
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: const Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8),
                  Text(
                      'Customer claims the pipe started leaking again 2 hours after completion. They are requesting a full refund of Rs 900.',
                  ...
                  Text(
                      'Images provided by customer show a minor leak at the joint.',
                      style: TextStyle(
            ...
            const Text('Your Response',
                style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            const SizedBox(height: 12),
            _buildOptionCard(0, 'Accept Responsibility',
                'I agree with the claim and will provide the requested resolution.'),
            const SizedBox(height: 8),
            _buildOptionCard(1, 'Dispute Claim',
                'I disagree. The issue was not caused by my work.'),
            const SizedBox(height: 8),
            _buildOptionCard(2, 'Propose Partial Resolution',
                'I accept partial responsibility and propose an alternative.'),
            const SizedBox(height: 32),

            // Upload Evidence (if disputing)
            if (_selectedOption == 1 || _selectedOption == 2) ...[
              const Text('Your Evidence',
            ...
            if (_selectedOption == 2) ...[
              const Text('Proposed Resolution',
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
              const SizedBox(height: 8),
              Container(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<String>(
                    value: _resolution,
                    isExpanded: true,
                    items: ['Refund 50%', 'Free Rework', 'Refund 25%']
  ...
  Widget _buildUploadBox() {
    return Container(
      ...
      child: const Center(
          child: Icon(Icons.add_a_photo, color: AppColors.inactive)),
    );
  }
}
