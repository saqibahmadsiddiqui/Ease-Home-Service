...
class ProviderPendingScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ProviderPendingScreen> createState() =>
      _ProviderPendingScreenState();
}

class _ProviderPendingScreenState extends ConsumerState<ProviderPendingScreen>
            ...
            children: [
              ...
              FadeTransition(
                ...
                child: Container(
                  ...
                  child: const Text('STATUS: UNDER REVIEW',
                      style: TextStyle(
              ...
              const SizedBox(height: 16),
              _buildStepRow('1', 'Document Verification',
                  'We are verifying your ID and certificates.', true),
              _buildStepRow('2', 'Background Check',
                  'Standard security check in progress.', false),
              _buildStepRow('3', 'Approval & Onboarding',
                  'Once approved, you can start accepting jobs.', false),
              ...
              SizedBox(
                ...
                child: OutlinedButton(
                  ...
                  child: const Text('Check Status Update',
                      style: TextStyle(fontWeight: FontWeight.bold)),
                ),
              ),
              const SizedBox(height: 16),
